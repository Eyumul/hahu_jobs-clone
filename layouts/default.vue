        ...
        <div class="fixed w-full bg-[#f1f1f1] dark:bg-transparent backdrop-filter backdrop-blur bg-opacity-50">
            <div class="flex items-center justify-between h-[75px] mx-[3%] ">
                ...
                <div class="hidden md:flex xl:space-x-10 md:space-x-4 xl:text-lg md:text-sm text-[#444f60] dark:text-prime-lighter items-end self-center">
                    <NuxtLink to="./" :class="{'text-[#009688] font-bold' : currentPath == '/', 'hover:text-[#009688] hover:scale-[110%] duration-500 cursor-pointer' : currentPath != '/'}">Home</NuxtLink>
                    <NuxtLink to="./#about" :class="{'text-[#009688] font-bold' : currentPath == '/#about', 'hover:text-[#009688] hover:scale-[110%] duration-500 cursor-pointer' : currentPath != '/#about'}">About</NuxtLink>
                    <div label="Open" @click="isOpen = true" class="hover:text-[#009688] hover:scale-[110%] duration-500 cursor-pointer">Jobs</div>
                    <NuxtLink to="./#postVacancy" :class="{'text-[#009688] font-bold' : currentPath == '/#postVacancy', 'hover:text-[#009688] hover:scale-[110%] duration-500 cursor-pointer' : currentPath != '/#postVacancy'}">Post Vacancy</NuxtLink>
                ...
                <div class="md:hidden text-second flex items-center gap-4">
                    ...
                    <svg v-else-if="menudrop" @click="menudrop = !menudrop" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div class="mx-[3%] my-4 flex flex-col text-second dark:text-prime-lighter gap-6" v-if="menudrop">
                ...
                <NuxtLink @click="menudrop = false" to="./#postVacancy" :class="{'text-[#009688] font-medium' : currentPath == '/#postVacancy', 'cursor-pointer font-medium' : currentPath != '/#postVacancy'}">Post Vacancy</NuxtLink>
                <NuxtLink @click="menudrop = false" class="cursor-pointer font-medium">Contact</NuxtLink>
                 ...
                 <div class="flex flex-col text-[#444f60] dark:text-white p-3 sm:p-6 lg:p-8">
                    <div class="flex justify-between gap-4 mb-4">
                        <div class="flex items-center space-x-8">
                            ...
                            <p class="text-sm sm:text-base lg:text-xl font-bold">Job by sector</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                        ...
                        <NuxtImg class="order-last lg:order-none lg:row-span-2 w-[350px] h-[300px] self-center" src="mascot-half.svg"/>
